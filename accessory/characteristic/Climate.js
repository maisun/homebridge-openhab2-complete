...
const CLIMATE_CONFIG = {
    ...
    minTemp: "minTemp",
    maxTemp: "maxTemp",
    //Allow to define min, max and step for heating/cooling threshold
...
function addWaterLevelCharacteristic(service, optional) {
    addNumericSensorCharacteristic.bind(this)(service, service.getCharacteristic(this.Characteristic.WaterLevel), {
        item: CLIMATE_CONFIG.waterLevelItem
    }, optional);
}
...
function addRotationSpeedCharacteristic(service, optional) {
    ...
    addNumericSensorActorCharacteristic.bind(this)(service, rotationSpeedCharacteristic, {
        item: CLIMATE_CONFIG.rotationSpeedItem
    }, optional);
}
...
function addCurrentRelativeHumidityCharacteristic(service, optional) {
    addNumericSensorCharacteristic.bind(this)(service, service.getCharacteristic(this.Characteristic.CurrentRelativeHumidity), {
        item: CLIMATE_CONFIG.currentHumidityItem
    }, optional);
}

function addTargetRelativeHumidityCharacteristic(service, optional) {
    addNumericSensorActorCharacteristic.bind(this)(service, service.getCharacteristic(this.Characteristic.TargetRelativeHumidity), {
        item: CLIMATE_CONFIG.targetHumidityItem
    }, optional);
}
...
function addCurrentTemperatureCharacteristic(service, optional) {
    ...
    addNumericSensorCharacteristicWithTransformation.bind(this)(service, currentTemperatureCharacteristic, {
...
function addTargetTemperatureCharacteristic(service, optional) {
    ...
    addNumericSensorActorCharacteristicWithDistinctTransformation.bind(this)(service, targetTemperatureCharacteristic, {
        item: CLIMATE_CONFIG.targetTempItem
    }, setTransformation, getTransformation, optional);
}
...
//Allow to define min, max and step for cooling threshold
function addCoolingThresholdCharacteristic(service, optional) {
    ...
    addNumericSensorActorCharacteristicWithDistinctTransformation.bind(this)(service, CoolingThresholdCharacteristic, {
        item: CLIMATE_CONFIG.coolingThresholdTempItem
    }, setTransformation, getTransformation, optional);
}
//Allow to define min, max and step for heating threshold
function addHeatingThresholdCharacteristic(service, optional) {
    ...
    addNumericSensorActorCharacteristicWithDistinctTransformation.bind(this)(service, HeatingThresholdCharacteristic, {
...
function addRelativeHumidityDehumidifierThresholdCharacteristic(service, optional) {
    addNumericSensorActorCharacteristic.bind(this)(service, service.getCharacteristic(this.Characteristic.RelativeHumidityDehumidifierThreshold), {
        item: CLIMATE_CONFIG.dehumidifierThresholdItem
    }, optional);
}

function addRelativeHumidityHumidifierThresholdCharacteristic(service, optional) {
    addNumericSensorActorCharacteristic.bind(this)(service, service.getCharacteristic(this.Characteristic.RelativeHumidityHumidifierThreshold), {
        item: CLIMATE_CONFIG.humidifierThresholdItem
    }, optional);
}
...
function addTemperatureDisplayUnitsCharacteristic(service) {
    ...
    service.getCharacteristic(this.Characteristic.TemperatureDisplayUnits).setValue(this._tempUnit);
}
module.exports = {
